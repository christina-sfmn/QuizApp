...
let mixedQuestions = []; // Array to save mixed questions
let currentQuestionIndex = 0; // Set initial index to 0
let currentQuestion; // Variable for current question -> undefined, bc at first there is no question
let answers = []; // Array to save answers
...
function displayQuestion() {
    ...
    if (currentQuestionIndex < mixedQuestions.length) {
        ...
        progress.innerText = `Question ${currentQuestionIndex + 1} of ${mixedQuestions.length}`;
